...
export class ProjectStatusTypeApiService {
    ...
    /**
     * Create many ProjectStatusType
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypeBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<ProjectStatusType>>;
    public projectStatusTypeBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ProjectStatusType>>>;
    public projectStatusTypeBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ProjectStatusType>>>;
    public projectStatusTypeBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling projectStatusTypeBulkPost.');
        }
        ...
        return this.httpClient.post<Array<ProjectStatusType>>(`${this.configuration.basePath}/project-status-type/bulk`,
            bulkDto,
            {
    ...
    /**
     * Retrieve many ProjectStatusType
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<ProjectStatusType>>;
    public projectStatusTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ProjectStatusType>>>;
    public projectStatusTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ProjectStatusType>>>;
    public projectStatusTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<ProjectStatusType>>(`${this.configuration.basePath}/project-status-type`,
            {
    ...
    /**
     * Delete one ProjectStatusType
     * @param id 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypeIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<ProjectStatusType>;
    public projectStatusTypeIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ProjectStatusType>>;
    public projectStatusTypeIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ProjectStatusType>>;
    public projectStatusTypeIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling projectStatusTypeIdDelete.');
        }
        ...
        return this.httpClient.delete<ProjectStatusType>(`${this.configuration.basePath}/project-status-type/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * Retrieve one ProjectStatusType
     * @param id 
     * @param fields &lt;h4&gt;Selects fields that should be returned in the reponse body.&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt; &lt;strong&gt;?fields&#x3D;field1,field2,...&lt;/strong&gt; &lt;br/&gt;&lt;i&gt;Example:&lt;/i&gt; &lt;strong&gt;?fields&#x3D;email,name&lt;/strong&gt;
     * @param join &lt;h4&gt;Receive joined relational objects in GET result (with all or selected fields).&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt;&lt;ul&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation||field1,field2,...&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation1||field11,field12,...&amp;join[]&#x3D;relation1.nested||field21,field22,...&amp;join[]&#x3D;...&lt;/strong&gt;&lt;/li&gt;&lt;/ul&gt;&lt;br/&gt;&lt;i&gt;Examples:&lt;/i&gt;&lt;/i&gt;&lt;ul&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile||firstName,email&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile||firstName,email&amp;join[]&#x3D;notifications||content&amp;join[]&#x3D;tasks&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation1&amp;join[]&#x3D;relation1.nested&amp;join[]&#x3D;relation1.nested.deepnested&lt;/strong&gt;&lt;/li&gt;&lt;/ul&gt;&lt;strong&gt;&lt;i&gt;Notice:&lt;/i&gt;&lt;/strong&gt; &lt;code&gt;id&lt;/code&gt; field always persists in relational objects. To use nested relations, the parent level MUST be set before the child level like example above.
     * @param cache &lt;h4&gt;Reset cache (if was enabled) and receive entities from the DB.&lt;/h4&gt;&lt;i&gt;Usage:&lt;/i&gt; &lt;strong&gt;?cache&#x3D;0&lt;/strong&gt;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<ProjectStatusType>;
    public projectStatusTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ProjectStatusType>>;
    public projectStatusTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ProjectStatusType>>;
    public projectStatusTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling projectStatusTypeIdGet.');
        }
        ...
        return this.httpClient.get<ProjectStatusType>(`${this.configuration.basePath}/project-status-type/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Update one ProjectStatusType
     * @param id 
     * @param projectStatusType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypeIdPatch(id: number, projectStatusType: ProjectStatusType, observe?: 'body', reportProgress?: boolean): Observable<ProjectStatusType>;
    public projectStatusTypeIdPatch(id: number, projectStatusType: ProjectStatusType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ProjectStatusType>>;
    public projectStatusTypeIdPatch(id: number, projectStatusType: ProjectStatusType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ProjectStatusType>>;
    public projectStatusTypeIdPatch(id: number, projectStatusType: ProjectStatusType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling projectStatusTypeIdPatch.');
        }
        if (projectStatusType === null || projectStatusType === undefined) {
            throw new Error('Required parameter projectStatusType was null or undefined when calling projectStatusTypeIdPatch.');
        }
        ...
        return this.httpClient.patch<ProjectStatusType>(`${this.configuration.basePath}/project-status-type/${encodeURIComponent(String(id))}`,
            projectStatusType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Create one ProjectStatusType
     * @param projectStatusType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public projectStatusTypePost(projectStatusType: ProjectStatusType, observe?: 'body', reportProgress?: boolean): Observable<ProjectStatusType>;
    public projectStatusTypePost(projectStatusType: ProjectStatusType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ProjectStatusType>>;
    public projectStatusTypePost(projectStatusType: ProjectStatusType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ProjectStatusType>>;
    public projectStatusTypePost(projectStatusType: ProjectStatusType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (projectStatusType === null || projectStatusType === undefined) {
            throw new Error('Required parameter projectStatusType was null or undefined when calling projectStatusTypePost.');
        }
        ...
        return this.httpClient.post<ProjectStatusType>(`${this.configuration.basePath}/project-status-type`,
            projectStatusType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
