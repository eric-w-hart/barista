...
import { DeploymentType } from '../model/deployment-type';
...
export class DeploymentTypeApiService {
    ...
    /**
     * Create many DeploymentType
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypeBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<DeploymentType>>;
    public deploymentTypeBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DeploymentType>>>;
    public deploymentTypeBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DeploymentType>>>;
    public deploymentTypeBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling deploymentTypeBulkPost.');
        }
        ...
        return this.httpClient.post<Array<DeploymentType>>(`${this.configuration.basePath}/deployment-type/bulk`,
            bulkDto,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<DeploymentType>>;
    public deploymentTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DeploymentType>>>;
    public deploymentTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DeploymentType>>>;
    public deploymentTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<DeploymentType>>(`${this.configuration.basePath}/deployment-type`,
            {
    ...
    /**
     * Delete one DeploymentType
     * @param id 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypeIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<DeploymentType>;
    public deploymentTypeIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DeploymentType>>;
    public deploymentTypeIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DeploymentType>>;
    public deploymentTypeIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deploymentTypeIdDelete.');
        }
        ...
        return this.httpClient.delete<DeploymentType>(`${this.configuration.basePath}/deployment-type/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<DeploymentType>;
    public deploymentTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DeploymentType>>;
    public deploymentTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DeploymentType>>;
    ...
    /**
     * Update one DeploymentType
     * @param id 
     * @param deploymentType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypeIdPatch(id: number, deploymentType: DeploymentType, observe?: 'body', reportProgress?: boolean): Observable<DeploymentType>;
    public deploymentTypeIdPatch(id: number, deploymentType: DeploymentType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DeploymentType>>;
    public deploymentTypeIdPatch(id: number, deploymentType: DeploymentType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DeploymentType>>;
    public deploymentTypeIdPatch(id: number, deploymentType: DeploymentType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deploymentTypeIdPatch.');
        }
        if (deploymentType === null || deploymentType === undefined) {
            throw new Error('Required parameter deploymentType was null or undefined when calling deploymentTypeIdPatch.');
        }
        ...
        return this.httpClient.patch<DeploymentType>(`${this.configuration.basePath}/deployment-type/${encodeURIComponent(String(id))}`,
            deploymentType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Create one DeploymentType
     * @param deploymentType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deploymentTypePost(deploymentType: DeploymentType, observe?: 'body', reportProgress?: boolean): Observable<DeploymentType>;
    public deploymentTypePost(deploymentType: DeploymentType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DeploymentType>>;
    public deploymentTypePost(deploymentType: DeploymentType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DeploymentType>>;
    public deploymentTypePost(deploymentType: DeploymentType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (deploymentType === null || deploymentType === undefined) {
            throw new Error('Required parameter deploymentType was null or undefined when calling deploymentTypePost.');
        }
        ...
        return this.httpClient.post<DeploymentType>(`${this.configuration.basePath}/deployment-type`,
            deploymentType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
