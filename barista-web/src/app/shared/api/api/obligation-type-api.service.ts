...
import { ObligationType } from '../model/obligation-type';
...
export class ObligationTypeApiService {
    ...
    /**
     * Create many ObligationType
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypeBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<ObligationType>>;
    public obligationTypeBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ObligationType>>>;
    public obligationTypeBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ObligationType>>>;
    public obligationTypeBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling obligationTypeBulkPost.');
        }
        ...
        return this.httpClient.post<Array<ObligationType>>(`${this.configuration.basePath}/obligation-type/bulk`,
            bulkDto,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<ObligationType>>;
    public obligationTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ObligationType>>>;
    public obligationTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ObligationType>>>;
    public obligationTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<ObligationType>>(`${this.configuration.basePath}/obligation-type`,
            {
    ...
    /**
     * Delete one ObligationType
     * @param id 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypeIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<ObligationType>;
    public obligationTypeIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ObligationType>>;
    public obligationTypeIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ObligationType>>;
    public obligationTypeIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling obligationTypeIdDelete.');
        }
        ...
        return this.httpClient.delete<ObligationType>(`${this.configuration.basePath}/obligation-type/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<ObligationType>;
    public obligationTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ObligationType>>;
    public obligationTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ObligationType>>;
    public obligationTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling obligationTypeIdGet.');
        }
        ...
        return this.httpClient.get<ObligationType>(`${this.configuration.basePath}/obligation-type/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Update one ObligationType
     * @param id 
     * @param obligationType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypeIdPatch(id: number, obligationType: ObligationType, observe?: 'body', reportProgress?: boolean): Observable<ObligationType>;
    public obligationTypeIdPatch(id: number, obligationType: ObligationType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ObligationType>>;
    public obligationTypeIdPatch(id: number, obligationType: ObligationType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ObligationType>>;
    public obligationTypeIdPatch(id: number, obligationType: ObligationType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling obligationTypeIdPatch.');
        }
        if (obligationType === null || obligationType === undefined) {
            throw new Error('Required parameter obligationType was null or undefined when calling obligationTypeIdPatch.');
        }
        ...
        return this.httpClient.patch<ObligationType>(`${this.configuration.basePath}/obligation-type/${encodeURIComponent(String(id))}`,
            obligationType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Create one ObligationType
     * @param obligationType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public obligationTypePost(obligationType: ObligationType, observe?: 'body', reportProgress?: boolean): Observable<ObligationType>;
    public obligationTypePost(obligationType: ObligationType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ObligationType>>;
    public obligationTypePost(obligationType: ObligationType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ObligationType>>;
    public obligationTypePost(obligationType: ObligationType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (obligationType === null || obligationType === undefined) {
            throw new Error('Required parameter obligationType was null or undefined when calling obligationTypePost.');
        }
        ...
        return this.httpClient.post<ObligationType>(`${this.configuration.basePath}/obligation-type`,
            obligationType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
