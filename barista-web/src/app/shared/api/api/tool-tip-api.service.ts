...
export class ToolTipApiService {
     ...
     */
    public tooltipGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<ToolTip>>;
    public tooltipGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ToolTip>>>;
    public tooltipGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ToolTip>>>;
    public tooltipGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<ToolTip>>(`${this.configuration.basePath}/tooltip`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tooltipIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<ToolTip>;
    public tooltipIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ToolTip>>;
    public tooltipIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ToolTip>>;
    public tooltipIdGet(id: number, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling tooltipIdGet.');
        }
        ...
        return this.httpClient.get<ToolTip>(`${this.configuration.basePath}/tooltip/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tooltipIdPatch(id: number, toolTip: ToolTip, observe?: 'body', reportProgress?: boolean): Observable<ToolTip>;
    public tooltipIdPatch(id: number, toolTip: ToolTip, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ToolTip>>;
    public tooltipIdPatch(id: number, toolTip: ToolTip, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ToolTip>>;
    public tooltipIdPatch(id: number, toolTip: ToolTip, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling tooltipIdPatch.');
        }
        if (toolTip === null || toolTip === undefined) {
            throw new Error('Required parameter toolTip was null or undefined when calling tooltipIdPatch.');
        }
        ...
        return this.httpClient.patch<ToolTip>(`${this.configuration.basePath}/tooltip/${encodeURIComponent(String(id))}`,
            toolTip,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
