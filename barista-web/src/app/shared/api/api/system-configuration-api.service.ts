...
export class SystemConfigurationApiService {
    ...
    /**
     * Create many SystemConfiguration
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public systemConfigurationBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<SystemConfiguration>>;
    public systemConfigurationBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<SystemConfiguration>>>;
    public systemConfigurationBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<SystemConfiguration>>>;
    public systemConfigurationBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling systemConfigurationBulkPost.');
        }
        ...
        return this.httpClient.post<Array<SystemConfiguration>>(`${this.configuration.basePath}/system-configuration/bulk`,
            bulkDto,
            {
    ...
    /**
     * Retrieve many SystemConfiguration
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public systemConfigurationGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<SystemConfiguration>>;
    public systemConfigurationGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<SystemConfiguration>>>;
    public systemConfigurationGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<SystemConfiguration>>>;
    public systemConfigurationGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<SystemConfiguration>>(`${this.configuration.basePath}/system-configuration`,
            {
    ...
    /**
     * Retrieve one SystemConfiguration
     * @param id 
     * @param fields &lt;h4&gt;Selects fields that should be returned in the reponse body.&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt; &lt;strong&gt;?fields&#x3D;field1,field2,...&lt;/strong&gt; &lt;br/&gt;&lt;i&gt;Example:&lt;/i&gt; &lt;strong&gt;?fields&#x3D;email,name&lt;/strong&gt;
     * @param join &lt;h4&gt;Receive joined relational objects in GET result (with all or selected fields).&lt;/h4&gt;&lt;i&gt;Syntax:&lt;/i&gt;&lt;ul&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation||field1,field2,...&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation1||field11,field12,...&amp;join[]&#x3D;relation1.nested||field21,field22,...&amp;join[]&#x3D;...&lt;/strong&gt;&lt;/li&gt;&lt;/ul&gt;&lt;br/&gt;&lt;i&gt;Examples:&lt;/i&gt;&lt;/i&gt;&lt;ul&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile||firstName,email&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;profile||firstName,email&amp;join[]&#x3D;notifications||content&amp;join[]&#x3D;tasks&lt;/strong&gt;&lt;/li&gt;&lt;li&gt;&lt;strong&gt;?join[]&#x3D;relation1&amp;join[]&#x3D;relation1.nested&amp;join[]&#x3D;relation1.nested.deepnested&lt;/strong&gt;&lt;/li&gt;&lt;/ul&gt;&lt;strong&gt;&lt;i&gt;Notice:&lt;/i&gt;&lt;/strong&gt; &lt;code&gt;id&lt;/code&gt; field always persists in relational objects. To use nested relations, the parent level MUST be set before the child level like example above.
     * @param cache &lt;h4&gt;Reset cache (if was enabled) and receive entities from the DB.&lt;/h4&gt;&lt;i&gt;Usage:&lt;/i&gt; &lt;strong&gt;?cache&#x3D;0&lt;/strong&gt;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public systemConfigurationIdGet(id: string, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<SystemConfiguration>;
    public systemConfigurationIdGet(id: string, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SystemConfiguration>>;
    public systemConfigurationIdGet(id: string, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SystemConfiguration>>;
    public systemConfigurationIdGet(id: string, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling systemConfigurationIdGet.');
        }
        ...
        return this.httpClient.get<SystemConfiguration>(`${this.configuration.basePath}/system-configuration/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public systemConfigurationIdPatch(id: string, systemConfiguration: SystemConfiguration, observe?: 'body', reportProgress?: boolean): Observable<SystemConfiguration>;
    public systemConfigurationIdPatch(id: string, systemConfiguration: SystemConfiguration, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SystemConfiguration>>;
    public systemConfigurationIdPatch(id: string, systemConfiguration: SystemConfiguration, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SystemConfiguration>>;
    public systemConfigurationIdPatch(id: string, systemConfiguration: SystemConfiguration, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling systemConfigurationIdPatch.');
        }
        if (systemConfiguration === null || systemConfiguration === undefined) {
            throw new Error('Required parameter systemConfiguration was null or undefined when calling systemConfigurationIdPatch.');
        }
        ...
        return this.httpClient.patch<SystemConfiguration>(`${this.configuration.basePath}/system-configuration/${encodeURIComponent(String(id))}`,
            systemConfiguration,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
