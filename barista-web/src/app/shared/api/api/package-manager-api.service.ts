...
import { PackageManager } from '../model/package-manager';
...
export class PackageManagerApiService {
    ...
    /**
     * Create many PackageManager
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<PackageManager>>;
    public packageManagerBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<PackageManager>>>;
    public packageManagerBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<PackageManager>>>;
    public packageManagerBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling packageManagerBulkPost.');
        }
        ...
        return this.httpClient.post<Array<PackageManager>>(`${this.configuration.basePath}/package-manager/bulk`,
            bulkDto,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<PackageManager>>;
    public packageManagerGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<PackageManager>>>;
    public packageManagerGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<PackageManager>>>;
    public packageManagerGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<PackageManager>>(`${this.configuration.basePath}/package-manager`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<PackageManager>;
    public packageManagerIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PackageManager>>;
    public packageManagerIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PackageManager>>;
    public packageManagerIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling packageManagerIdDelete.');
        }
        ...
        return this.httpClient.delete<PackageManager>(`${this.configuration.basePath}/package-manager/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<PackageManager>;
    public packageManagerIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PackageManager>>;
    public packageManagerIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PackageManager>>;
    public packageManagerIdGet(id: number, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling packageManagerIdGet.');
        }
        ...
        return this.httpClient.get<PackageManager>(`${this.configuration.basePath}/package-manager/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerIdPatch(id: number, packageManager: PackageManager, observe?: 'body', reportProgress?: boolean): Observable<PackageManager>;
    public packageManagerIdPatch(id: number, packageManager: PackageManager, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PackageManager>>;
    public packageManagerIdPatch(id: number, packageManager: PackageManager, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PackageManager>>;
    public packageManagerIdPatch(id: number, packageManager: PackageManager, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling packageManagerIdPatch.');
        }
        if (packageManager === null || packageManager === undefined) {
            throw new Error('Required parameter packageManager was null or undefined when calling packageManagerIdPatch.');
        }
        ...
        return this.httpClient.patch<PackageManager>(`${this.configuration.basePath}/package-manager/${encodeURIComponent(String(id))}`,
            packageManager,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public packageManagerPost(packageManager: PackageManager, observe?: 'body', reportProgress?: boolean): Observable<PackageManager>;
    public packageManagerPost(packageManager: PackageManager, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PackageManager>>;
    public packageManagerPost(packageManager: PackageManager, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PackageManager>>;
    public packageManagerPost(packageManager: PackageManager, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (packageManager === null || packageManager === undefined) {
            throw new Error('Required parameter packageManager was null or undefined when calling packageManagerPost.');
        }
        ...
        return this.httpClient.post<PackageManager>(`${this.configuration.basePath}/package-manager`,
            packageManager,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
