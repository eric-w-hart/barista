...
import { OutputFormatType } from '../model/output-format-type';
...
export class OutputFormatTypeApiService {
    ...
    /**
     * Create many OutputFormatType
     * @param bulkDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypeBulkPost(bulkDto: object, observe?: 'body', reportProgress?: boolean): Observable<Array<OutputFormatType>>;
    public outputFormatTypeBulkPost(bulkDto: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<OutputFormatType>>>;
    public outputFormatTypeBulkPost(bulkDto: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<OutputFormatType>>>;
    public outputFormatTypeBulkPost(bulkDto: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (bulkDto === null || bulkDto === undefined) {
            throw new Error('Required parameter bulkDto was null or undefined when calling outputFormatTypeBulkPost.');
        }
        ...
        return this.httpClient.post<Array<OutputFormatType>>(`${this.configuration.basePath}/output-format-type/bulk`,
            bulkDto,
            {
    ...
    /**
     * Retrieve many OutputFormatType
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<OutputFormatType>>;
    public outputFormatTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<OutputFormatType>>>;
    public outputFormatTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<OutputFormatType>>>;
    public outputFormatTypeGet(fields?: string, filter?: string, or?: string, sort?: string, join?: string, perPage?: number, offset?: number, page?: number, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<OutputFormatType>>(`${this.configuration.basePath}/output-format-type`,
            {
    ...
    /**
     * Delete one OutputFormatType
     * @param id 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypeIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<OutputFormatType>;
    public outputFormatTypeIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OutputFormatType>>;
    public outputFormatTypeIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OutputFormatType>>;
    public outputFormatTypeIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling outputFormatTypeIdDelete.');
        }
        ...
        return this.httpClient.delete<OutputFormatType>(`${this.configuration.basePath}/output-format-type/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'body', reportProgress?: boolean): Observable<OutputFormatType>;
    public outputFormatTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OutputFormatType>>;
    public outputFormatTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OutputFormatType>>;
    public outputFormatTypeIdGet(id: number, fields?: string, join?: string, cache?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling outputFormatTypeIdGet.');
        }
        ...
        return this.httpClient.get<OutputFormatType>(`${this.configuration.basePath}/output-format-type/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Update one OutputFormatType
     * @param id 
     * @param outputFormatType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypeIdPatch(id: number, outputFormatType: OutputFormatType, observe?: 'body', reportProgress?: boolean): Observable<OutputFormatType>;
    public outputFormatTypeIdPatch(id: number, outputFormatType: OutputFormatType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OutputFormatType>>;
    public outputFormatTypeIdPatch(id: number, outputFormatType: OutputFormatType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OutputFormatType>>;
    public outputFormatTypeIdPatch(id: number, outputFormatType: OutputFormatType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling outputFormatTypeIdPatch.');
        }
        if (outputFormatType === null || outputFormatType === undefined) {
            throw new Error('Required parameter outputFormatType was null or undefined when calling outputFormatTypeIdPatch.');
        }
        ...
        return this.httpClient.patch<OutputFormatType>(`${this.configuration.basePath}/output-format-type/${encodeURIComponent(String(id))}`,
            outputFormatType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Create one OutputFormatType
     * @param outputFormatType 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public outputFormatTypePost(outputFormatType: OutputFormatType, observe?: 'body', reportProgress?: boolean): Observable<OutputFormatType>;
    public outputFormatTypePost(outputFormatType: OutputFormatType, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OutputFormatType>>;
    public outputFormatTypePost(outputFormatType: OutputFormatType, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OutputFormatType>>;
    public outputFormatTypePost(outputFormatType: OutputFormatType, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (outputFormatType === null || outputFormatType === undefined) {
            throw new Error('Required parameter outputFormatType was null or undefined when calling outputFormatTypePost.');
        }
        ...
        return this.httpClient.post<OutputFormatType>(`${this.configuration.basePath}/output-format-type`,
            outputFormatType,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
